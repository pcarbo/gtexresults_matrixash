...
Check to see if the QTLs have expression values that are tissue-specific. Here, I show densitys of the normalized effects for susbets of genes, where the normalized effects are defined as:
